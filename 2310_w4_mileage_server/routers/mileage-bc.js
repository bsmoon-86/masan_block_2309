...
const sc2 = require("../reference/sc_class")
// Milage class 생성
const sc_class = new sc2.Mileage()
...
module.exports = function(){
    ...
    router.get('/payment', async function(req, res){
        ...
        // )
        ////////////////////////////////////////////////////////////////
        // sc_class.js를 이용하는 경우
        const result = await sc_class.payment(user, amount)
        ////////////////////////////////////////////////////////////////
    ...
    router.post('/transaction', async function(req, res){
        ...
        ////////////////////////////////////////////////////////////////
        // sc_class.js를 이용하는 경우
        const result = await sc_class.transaction(sender, receiver, amount)
        ...
        ////////////////////////////////////////////////////////////////
        // sc_class.js를 이용하는 경우
        const result2 = await sc_class.balance(sender)
